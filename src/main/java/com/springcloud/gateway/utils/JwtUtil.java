...
public final class JwtUtil {
    private static final int millisecondToSecond = 1000;
...
/*    public String getUsername(String token){
        return this.getClaimsFromToken(token).get("username").toString();
    }*/

/*    public String getUserRole(String token){
        return this.getClaimsFromToken(token).get("role").toString();
    }*/
